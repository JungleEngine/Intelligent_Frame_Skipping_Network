...
class DiscriminatorTrainer(BaseTrain):
    def __init__(self, sess, model, data, config, logger):
        super(DiscriminatorTrainer, self).__init__(sess, model, data, config, logger)
    ...
    def train_step(self):
        ...
        feed_dict = {self.model.x1: batch_x[:, 0], self.model.x2: batch_x[:, 1],
                     self.model.y: batch_y, self.model.is_training: 1, self.model.hold_prob_conv: 0.25,
                     self.model.hold_prob_fc: 0.5}
        ...
        # Run without dropout
        feed_dict = {self.model.x1: batch_x[:, 0], self.model.x2: batch_x[:, 1],
                     self.model.y: batch_y, self.model.is_training: 0, self.model.hold_prob_conv: 1.0,
                     self.model.hold_prob_fc: 1.0}
    ...
    def validate_step(self):
        ...
        feed_dict = {self.model.x1: batch_x[:, 0],
                     self.model.x2: batch_x[:, 1], self.model.y: batch_y, self.model.is_training: 0,
                     self.model.hold_prob_conv: 1.0,
                     self.model.hold_prob_fc: 1.0}
